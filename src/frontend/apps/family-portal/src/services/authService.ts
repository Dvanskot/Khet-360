...
export class AuthService {
  ...
  static hasRole(role: string): boolean {
    // This would typically check user roles from token or user profile
    // For now, we'll return true as a placeholder
    // In a real implementation, you'd decode the JWT and check roles
    return true;
  }

  static hasPermission(permission: string): boolean {
    // This would typically check user permissions from token or user profile
    // For now, we'll return true as a placeholder
    return true;
  }
}
