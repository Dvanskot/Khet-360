...
// Handles connection to the notification hub for real-time updates across the application
...
export class SignalRService {
  ...
  private notifyConnectionStatusChange(isConnected: boolean, string) {
